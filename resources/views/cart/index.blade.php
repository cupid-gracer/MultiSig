            ...
            <form action="{{ route('profile.cart.add', \App\Product::find($productId)) }}" method="POST">
                ...
                <div class="form-row bg-light">
                    ...
                    <div class="col-md-3 d-flex align-items-stretch">
                        <textarea name="message" id="message" rows="3" placeholder="Message will be encrypted with vendor's PGP key. Click on Save message BEFORE clicking Checkout!" style="resize: 0" class="form-control form-control-sm">{{ $item -> message }}</textarea><br>
                    </div>
