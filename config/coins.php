...
return [
    ...
    'coin_list' => [
       ...
       'btcm' => \App\Marketplace\Payment\BitcoinMultisig::class, // bitcoin multisig
...
//        'xvg' => \App\Marketplace\Payment\VergeCoin::class,
    ...
    'monero' => [
        ...
        // 'username' => env('MONERO_USERNAME','mytestwallet'),
        'password' => env('MONERO_PASSWORD','testwallet')
        // 'password' => env('MONERO_PASSWORD','mytestpassword')
    ...
    'market_addresses' => [
        'btc' => [ // list of btc addresses
            'tb1qtlws4j3vl9hr73lhmphkuygpy7d8shwmwwdk9e'
        ],
        'xmr' => [ // list of xmr addresses
            '464Eg71N3CvPPmJYVPQakPN1snwyYQnAWCFD1nTNKPi3KnRD8jXBKH1AA8DyzwwvPoDHtYm3zpYs3YGSWQ1Bz5ECJYASCNc'
        ],
        'dash' => [
