...
class AdminController extends Controller
{
    ...
    {
        $this -> disputesCheck();
        // dd(Dispute::paginate(config('marketplace.products_per_page')));
    ...
    public function resolveDispute(ResolveDisputeRequest $request, Purchase $purchase)
    {
        ...
        try{
            ...
            if($purchase -> dispute -> winner_id != null)
                session() -> flash('success', 'You have successfully resolved this dispute!');
            else
                session() -> flash('success', 'You have successfully generated raw transaction!');
        }
        catch (RequestException $e){
            $e -> flashError();
        }
