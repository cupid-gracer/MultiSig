...
Route::prefix('profile')->group(function(){
    ...
    Route::get('sales/{sale}/generatetx', 'VendorController@generateTx') -> name('profile.sales.generatetx');
    Route::post('sales/{sale}/submittx', 'VendorController@submitVendorTx') -> name('profile.sales.submit.tx');
    ...
    Route::post('purchase/{purchase}/delivered', 'ProfileController@markAsDeliveredTx') -> name('profile.purchases.delivered.tx');
    Route::post('purchase/{purchase}/submittx', 'ProfileController@submitDesputeTx') -> name('profile.purchases.submit.despute.tx');
    ...
    Route::post('purchase/{purchase}/dispute/generateTx', 'Admin\AdminController@generateTx') -> name('profile.purchases.disputes.generateTx');
