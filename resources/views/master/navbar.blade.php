<?php
$loccurxmr = Cache::remember('loccurxmr', 2, function() {
$url = "https://min-api.cryptocompare.com/data/price?fsym=XMR&tsyms=GBP,USD,CAD,EUR,INR,HUF,JPY,AUD,CHF,NZD,RUB,CNY,BGN,ILS,PHP,TRY,HKD,MYR,HRK,CZK,IDR,DKK,NOK,MXN,THB,ISK,ZAR,BRL,SGD,PLN,KRW,RON,CNY,SEK";
            $json = json_decode(file_get_contents($url), true);
            $loccurxmr = $json[ \App\Marketplace\Utility\CurrencyConverter::getLocalCurrency() ];
    return $loccurxmr;
});
$loccurbtc = Cache::remember('loccurbtc', 60, function() {  
$url = "https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=GBP,USD,CAD,EUR,INR,HUF,JPY,AUD,CHF,NZD,RUB,CNY,BGN,ILS,PHP,TRY,HKD,MYR,HRK,CZK,IDR,DKK,NOK,MXN,THB,ISK,ZAR,BRL,SGD,PLN,KRW,RON,CNY,SEK";
            $json = json_decode(file_get_contents($url), true);
            $loccurbtc = $json[ \App\Marketplace\Utility\CurrencyConverter::getLocalCurrency() ];
return $loccurbtc;
});
?>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-fill justify-content-center">
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="#">1 XMR = {{ \App\Marketplace\Utility\CurrencyConverter::getLocalSymbol() }}{{ $loccurxmr }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">1 BTC = {{ \App\Marketplace\Utility\CurrencyConverter::getLocalSymbol() }}{{ $loccurbtc }}</a>
                        </li>
                     @endauth
                 </ul>
